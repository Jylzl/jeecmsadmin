              ...
              >
                ...
                >
                  <div class="show-pswd">
                    ...
                    ><i
                        class="el-icon-view"
                        @mousedown="showPswd('text')"
                        @mouseup="showPswd('password')"
                      ></i></el-button>
                  </div>
                </el-form-item>
            ...
            <div class="card-box-two">
              ...
              >
                <el-row :gutter="20">
                  <el-col :span="8">
                    <el-form-item prop="age">
                      <el-select
                        v-model="landForm_phone.areaCode"
                        placeholder="请选择"
                      >
                        <el-option
                ...
                <el-form-item style="margin-bottom:0;">
                  <el-button
                    type="primary"
                    @click="submitForm('landForm_phone')"
                    style="width:100%;"
                    :disabled="landLoading.disabled"
                    :icon="landLoading.icon"
                  >{{landLoading.content}}</el-button>
...
export default {
  ...
  methods: {
    ...
    submitForm(formName) {
      ...
      // 解密
      var plaintext = tripledes
        .decrypt(ciphertext, "123")
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          if (
            ...
            let newArr = this.rememberUsers.filter(
              user => user.value != this.landForm_password.user
            );
            console.log("B----------");
            console.log(newArr);
            this.rememberUsers = newArr;
            ...
            console.log("c----------");
            console.log(this.rememberUsers);
            console.log(this.rememberUsers.toString());
...
.land-box-center {
  ...
  height: 542px;
  padding-left: 679px;
  background: #fff url(../../assets/img/land_bg_center.png) no-repeat center
    left;
