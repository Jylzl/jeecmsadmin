    ...
    operate: {
        ...
        word: {
            ...
            label: {
                ...
                other: 'other',
                yearAmount: 'Charging this year',
                monthAmount: 'Charging this month',
                dayAmount: 'Charging this day',
                lastBuyTime: 'Latest Purchase Time',
        ...
        ad: {
            ...
            label: {
                ...
                attr_flash_height: 'FlashHeight',
                attr_flash_width: 'FlashWidth',
        ...
        weixin: {
            ...
            label: {
                ...
                weixinImage: 'Wechat Two-Dimensional Code',
                updateNull: 'Leave it blank without modification',
                id: 'ID',
                menuName: 'Menu name',
                operate: 'Operation options',
                click: 'Click events',
                viewurl: "URL address",
                menuType: 'Menu type',
                key: 'Key',
                keyTip: 'Click events KEY(Custom Response Keyword)',
                number: 'Keyword',
                title: 'Title',
                url: 'Link address',
                img: 'picture',
            ...
            rules: {},
            submenu: {
                weixinConfig: 'wechatSet',
                weixin: 'wechatSet',
                weixinMenu: 'setMenu',
                weixinMenuList: 'menuList',
                weixinMenuAdd: 'addMenu',
                weixinMenuEdit: 'editMenu',
                childList: 'list',
                child: 'subMenu',
                childAdd: 'add',
                childUpdate: 'edit',
                weixinMessage: 'setReply',
                weixinMessageList: 'replyList',
                weixinMessageAdd: 'addReply',
                weixinMessageEdit: 'editReply',
            }
        },
        vote: {
            mes: {},
            label: {
                ...
                beforethestart: 'noStart',
                ing: 'ing',
                over: 'ended',
                voteview: 'See',
                default: 'default',
                dateRange: 'Term of validity',
                to: 'to',
                startDate: 'startTime',
                endDate: 'endTime',
                description: 'Explain',
                isabled: 'open',
                repeateHour: 'repeated',
                enabled: 'enabled',
                disabled: 'disabled',
            ...
            btn: {
                ...
                processing: 'ing',
                over: 'ended',
                saveContent: 'saveChange',
                addRadioSubject: 'Single choice question',
                addCheckedSubject: 'Multiple choice questions',
                addQue: 'Multiple choice questions',
            },
            rules: {},
            submenu: {
                vote: 'Survey',
