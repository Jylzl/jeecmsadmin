...
<template>
    <div style="margin-bottom:12px;">
        <el-upload class="upload-attach" :action="uploadUrl" :data="data" :multiple="multiple" :limit="limit"
            :name="name" :auto-upload="auto_upload" :before-upload="beforeAvatarUpload" :on-success="onSuccess"
            :on-error="onError" :show-file-list="show_file_list" :file-list="fileList" ref="upload">
