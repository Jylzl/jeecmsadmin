...
(function () {
    ...
    if (pres.length) {
      if (typeof XRegExp == "undefined") {
        ...
        if (this.rootPath !== undefined) {
          ...
          cssurl =
            utils.removeLastbs(this.rootPath) +
            "/third-party/SyntaxHighlighter/shCoreDefault.min.css";
        } else {
  ...
  UE.parse.register("charts", function (utils) {
    ...
    function extractChartData(rootNode) {
      ...
      for (var i = 0, tableNode;
        (tableNode = tables[i]); i++) {
    ...
    function loadHighcharts() {
      ...
      if (!window.Highcharts) {
        utils.loadFile(
          document, {
            src: resourceRoot + "/third-party/highcharts/highcharts.min.js",
            tag: "script",
            type: "text/javascript",
            defer: "defer"
          },
    ...
    function loadTypeConfig() {
      utils.loadFile(
        document, {
          src: resourceRoot + "/dialogs/charts/chart.config.min.js",
          tag: "script",
          type: "text/javascript",
          defer: "defer"
        },
